...
INSERT INTO clients (id_of_agent, first_name, last_name, email, phone_number, searched_state, searched_county, searched_place)
VALUES
(1, 'Emily', 'Johnson', 'emily.johnson@example.com', '301-555-0171', 'MD', 'Montgomery', 'Rockville'),
(1, 'Michael', 'Smith', 'michael.smith@example.com', '410-555-0145', 'MD', 'Anne Arundel', 'Annapolis'),
(1, 'Sarah', 'Davis', 'sarah.davis@example.com', '240-555-0199', 'MD', 'Prince Georges', 'Bowie'),
(2, 'David', 'Brown', 'david.brown@example.com', '443-555-0123', 'MD', 'Baltimore', 'Baltimore'),
(2, 'Jessica', 'Garcia', 'jessica.garcia@example.com', '301-555-0188', 'MD', 'Howard', 'Ellicott City');
